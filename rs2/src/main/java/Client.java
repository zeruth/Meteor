...
@Implements("RSClient")
public final class Client extends NetworkedGame {
...
label0:
	...
	protected void method43(int i, int j, byte[] buffer) {
		try {
			...
			if(i == 53) {
				...
				KEventKt.getKEVENT().post(new UpdateInventoryPacket());
				return;
			}
			if(i == 234) {
	...
	public static Client mudClient;

	public static void initClient(String[] args) {
		mudClient.initMembers();
...
/*		if(aBoolean782) {
	...
	private Character[] aCharacterArray717;
	...
	private Character[] aCharacterArray807;
	...
	private int[] shopItemQuantities;
	private int shopPriceMod;
	private int[] shopItemPrices;
