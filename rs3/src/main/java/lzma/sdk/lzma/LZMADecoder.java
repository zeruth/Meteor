...
import lzma.sdk.rangecoder.RangeCoderDecoder;
...
public class LZMADecoder {
    ...
    public RangeCoderDecoder m_RangeDecoder = new RangeCoderDecoder();
    ...
    public static int reverseDecode(short[] arg0, int arg1, RangeCoderDecoder arg2, int arg3) throws IOException {
		int var4 = 1;
		int var5 = 0;
    ...
    public static class LenDecoder {
		...
		// line 174
		public LenDecoder(LZMADecoder arg0) {
			this.this$0 = arg0;
        ...
        public int decode(RangeCoderDecoder rangeDecoder, int posState) throws IOException {
    ...
    public static class LiteralDecoder {
		...
		// line 207
		public LiteralDecoder(LZMADecoder arg0) {
			this.this$0 = arg0;
		}
        ...
        public static class Decoder2 {
            ...
            public byte decodeNormal(RangeCoderDecoder rangeDecoder) throws IOException {
				int symbol = 1;
				do {
            ...
            public byte decodeWithMatchByte(RangeCoderDecoder rangeDecoder, byte matchByte) throws IOException {
				int symbol = 1;
				do {
