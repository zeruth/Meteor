...
public abstract class GlxBaseTexture implements BaseTexture {
    ...
    public void method7638(int arg0, int arg1, int arg2, int[] arg3) {
		if (this.field4974 == 0) {
			...
			while (true) {
				OpenGL.glTexImage2Di(arg0, var5, GlxToolkit.method19077(this.field4973, this.field4977), arg1, arg2, 0, 32993, this.field4980.field12027, var9, 0);
				if (var6 <= 1) {
					return;
				}
				int var11 = 0;
    ...
    public void method7634(int arg0, int arg1, int arg2, byte[] arg3) {
		if (this.field4974 == 0) {
			...
			while (true) {
				OpenGL.glTexImage2Dub(arg0, var6, GlxToolkit.method19077(this.field4973, this.field4977), arg1, arg2, 0, GlxToolkit.method19085(this.field4973), 5121, var10, 0);
				if (var7 <= 1) {
					return;
				}
				int var12 = arg1 * var5;
    ...
    public void method7635(int arg0, int arg1, int arg2, float[] arg3) {
		if (this.field4974 == 0) {
			...
			while (true) {
				OpenGL.glTexImage2Df(arg0, var6, GlxToolkit.method19077(this.field4973, this.field4977), arg1, arg2, 0, GlxToolkit.method19085(this.field4973), 5126, var10, 0);
				if (var7 <= 1) {
					return;
				}
				int var12 = arg1 * var5;
