...
public class PureJavaSpriteNormal extends PureJavaSprite {
    ...
    public void draw(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		for (int var8 = 0; var8 < arg3; var8++) {
			...
			int var10 = this.field9373.sizeX * (arg5 + var8) + arg4;
			for (int var11 = 0; var11 < arg2; var11++) {
    ...
    public void drawSprite(int x, int y, int arg2, int rgb, int arg4) {
		...
		if (arg4 == 0) {
			...
			if (arg2 == 1) {
				...
				int var103 = rgb >> 16 & 0xFF;
				int var104 = rgb >> 8 & 0xFF;
				int var105 = rgb & 0xFF;
				...
				for (int var117 = -var12; var117 < 0; var117++) {
					for (int var118 = -var13; var118 < 0; var118++) {
						...
						int var120 = rgb + var119;
						int var121 = (rgb & 0xFF00FF) + (var119 & 0xFF00FF);
				...
				int var130 = (rgb & 0xFF00FF) * var129 & 0xFF00FF00;
				int var131 = (rgb & 0xFF00) * var129 & 0xFF0000;
			...
			if ((rgb & 0xFFFFFF) == 16777215) {
				...
				int var59 = rgb >> 16 & 0xFF;
				int var60 = rgb >> 8 & 0xFF;
				int var61 = rgb & 0xFF;
				int var62 = rgb >>> 24;
				int var63 = 256 - var62;
			...
			for (int var77 = -var12; var77 < 0; var77++) {
				for (int var78 = -var13; var78 < 0; var78++) {
					...
					int var80 = rgb + var79;
					int var81 = (rgb & 0xFF00FF) + (var79 & 0xFF00FF);
			...
			int var86 = rgb >>> 24;
			int var87 = 256 - var86;
			int var88 = (rgb & 0xFF00FF) * var87 & 0xFF00FF00;
			int var89 = (rgb & 0xFF00) * var87 & 0xFF0000;
    ...
    public void method18947(int arg0, int arg1, int[] arg2, int arg3, int arg4) {
		...
		if (arg4 == 0) {
			...
			if (arg3 == 1) {
				...
				int var57 = PureJavaSprite.field9361;
			...
			if (var19 != 0) {
				if ((PureJavaSprite.field9361 & 0xFFFFFF) == 16777215) {
					int var20 = PureJavaSprite.field9361 >>> 24;
					int var21 = 256 - var20;
					int var22 = arg2[arg1];
			...
			int var32 = PureJavaSprite.field9361;
