...
public abstract class GlTexture {
    ...
    public static void method1107(int arg0, int arg1, int arg2, int arg3, TextureFormat arg4, byte[] arg5) {
		if (arg2 > 0 && !IntMath.method4918(arg2)) {
			...
			while (true) {
				OpenGL.glTexImage2Dub(arg0, var7, arg1, arg2, arg3, 0, GlToolkit.method15899(arg4), 5121, var11, 0);
				if (var8 <= 1) {
					return;
				}
				int var13 = arg2 * var6;
    ...
    public static void method1091(int arg0, int arg1, int arg2, int arg3, TextureFormat arg4, float[] arg5) {
		if (arg2 > 0 && !IntMath.method4918(arg2)) {
			...
			while (true) {
				OpenGL.glTexImage2Df(arg0, var7, arg1, arg2, arg3, 0, GlToolkit.method15899(arg4), 5126, var11, 0);
				if (var8 <= 1) {
					return;
				}
				int var13 = arg2 * var6;
