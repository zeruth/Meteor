...
public class GlEnvironmentMapEffect extends GlEffect {
	...
	public GlEnvironmentMapEffect(GlToolkit arg0) {
		...
		if (arg0.field9952) {
			...
			this.field9338 = new GlCubeTexture[3];
			this.field9338[0] = new GlCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var3, TextureFormat.ALPHA);
			this.field9338[1] = new GlCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var4, TextureFormat.ALPHA);
			this.field9338[2] = new GlCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var2, TextureFormat.ALPHA);
			this.method15349();
		}
	}
